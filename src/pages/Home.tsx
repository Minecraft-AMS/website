        ...
        <div className="relative max-w-6xl mx-auto w-full">
          <div className={`transition-all duration-1000 delay-300 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/join"
                className="group w-[160px] flex items-center justify-center gap-3 px-8 py-4 bg-[#c9a962] text-black text-sm tracking-wider hover:bg-[#d4a373] transition-colors"
              >
                <span>立即加入</span>
              ...
              <Link
                to="/about"
                className="w-[160px] flex items-center justify-center px-8 py-4 border border-[#c9a962]/50 text-[#c9a962] text-sm tracking-wider hover:bg-[#c9a962]/10 transition-all"
              >
                关于我们
              </Link>
            </div>
